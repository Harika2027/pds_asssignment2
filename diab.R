...
diabetes = read.csv("/Users/harikachowdary/Downloads/diabetes.csv")
diabetes
...
barplot(stats, main="Comparison of Glucose Statistics", ylab="Glucose", col=c("red", "yellow", "red", "yellow"), ylim=c(0, 250))
...
hist(sample(bmi, length(bmi), replace=TRUE), breaks=20, xlab="BMI", main="BMI Distribution for Sample", col="blue",border = "black")
